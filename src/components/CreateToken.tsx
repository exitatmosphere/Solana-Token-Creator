...
export const CreateToken: FC = () => {
        ...
        try {
            const tx = new Transaction().add(
                ...
                createCreateMetadataAccountInstruction(
                    {
                        metadata: (await PublicKey.findProgramAddress([Buffer.from('metadata'), PROGRAM_ID.toBuffer(), mintKeypair.publicKey.toBuffer()], PROGRAM_ID))[0],
    ...
    }, [publicKey, connection, tokenDecimals, tokenName, tokenSymbol, tokenUri, sendTransaction]);
